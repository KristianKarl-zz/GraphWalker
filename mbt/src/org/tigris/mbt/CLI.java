 ...
 * 
 * <pre>
 * java -jar mbt.jar COMMAND <options>
 * </pre>
 * 
 * Where mbt.jar is the whole package org.tigris.mbt built using the tool Fat
 * Jar from http://fjep.sourceforge.net/ using org.tigris.mbt.CLI as the main
 * class<br>
 * <br>
 ...
 * 
 * <pre>
 * java -jar mbt.jar online -f folder -g A_STAR -s EDGE_COVERAGE:100
 * </pre>
 * 
 * <br>
...
public class CLI {
	...
	private void printVersionInformation() {
		System.out.println("org.tigris.mbt version 2.2 (revision 800) Beta 15\n");
